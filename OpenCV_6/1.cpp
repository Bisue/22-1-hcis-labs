...
//Mat erosionImage(const Mat& image, const Mat& kernel)
//{
//	Mat erosion;
//
...
//Mat dilationImage(const Mat& image, const Mat& kernel)
//{
//	Mat dilation;
//
...
//
//	// 1. 각 이미지의 erosion
//	Mat erosionStuff = erosionImage(grayStuff, kernel);
//	Mat erosionRice = erosionImage(grayRice, kernel);
//
//	// 중간 출력 이미지 저장
...
//	Mat dilationStuff = dilationImage(erosionStuff, kernel);
//	Mat dilationRice = dilationImage(erosionRice, kernel);
//
//	// 중간 출력 이미지 저장
...
//	Mat subtractStuff = cp.GS_subtract_image(grayStuff, dilationStuff);
//	Mat subtractRice = cp.GS_subtract_image(grayRice, dilationRice);
//
//	// 중간 출력 이미지 저장
